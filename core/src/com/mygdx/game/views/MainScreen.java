...
//         hp drawing
    ...
    private Player createPlayer(int playerIndex, int playerNumber) { //TODO change a lot of things
        if (playerNumber == 1)
            switch (playerIndex) {
                case 0: return new SaiHan(world, 1, this, PLAYER1_CONTROL_SCHEME, -15, -2);
                case 1: return new King(world, 1, this, PLAYER1_CONTROL_SCHEME, -15, -2);
                case 2: return new Huntress(world, 1, this, PLAYER1_CONTROL_SCHEME, -15, -2);
                case 3: return new HeroKnight(world, 1, this, PLAYER1_CONTROL_SCHEME, -15, -2);
                default: return null;
            }
        else
            switch (playerIndex) {
                case 0: return new SaiHan(world, 2, this, PLAYER2_CONTROL_SCHEME, 15, -2);
                case 1: return new King(world, 2, this, PLAYER2_CONTROL_SCHEME, 15, -2);
                case 2: return new Huntress(world, 2, this, PLAYER2_CONTROL_SCHEME, 15, -2);
                case 3: return new HeroKnight(world, 2, this, PLAYER2_CONTROL_SCHEME, 15, -2);
                default: return null;
            }
    }
    ...
    private String getPlayerName(int index) {
        switch (index) {
            case SAI_HAN: return "SaiHan";
            case KING: return "King";
            case HERO_KNIGHT: return "HeroKnight";
